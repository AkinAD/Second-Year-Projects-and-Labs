...
public final class Complex {
	...
	public Complex add(Complex c) {
		Complex result =  new Complex (c.re + re, c.im + im);
		return result;
	}
	...
	public Complex multiply(Complex c) {
		Complex result =  new Complex ((re*c.re - im*c.im), (re*c.im + im*c.re));
		return result;
	}
		...
		if (parts.size()  == 3)
		{
			...
			{	String third= parts.get(2);
				if (third.contains("i"))
				{
					...
					throw new IllegalArgumentException("She didn't open cloth!");
				}
			}
			else {
