...
public class CellPhone {
	...
	public CellPhone(CellNumber number, List<CellNumber> callLog) {
		...
		if (callLog != null)
		{			
		for (CellNumber C : callLog)  // i think this means  "for every cell number item in callLog"
		{	//this entire thing is a deep copy
	...
	public CellNumber getNumber() {
		CellNumber CN =  new CellNumber(number);
		return CN;
	}
	...
	public void setNumber(CellNumber number) {
		...
		if (number == null)
		{
			throw new IllegalArgumentException("Boy in what universe is a phone number null");
		}
		this.number = CN;
	}
	...
	public List<CellNumber> getCallLog() {
		List<CellNumber> copyCL =  new ArrayList<CellNumber>(this.callLog);
		return copyCL;
	}
	...
	public void dial(CellNumber number) {
		if (number ==  null)
			throw new  IllegalArgumentException("Calling more Ghost numbers eh");
